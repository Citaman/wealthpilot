...
- **Enhancements**:
    ...
    - **Interactive Simulation**: "What happens if I save €500 more this month?"
...
### 3.1 App Lock (PIN)
- **Features**: 4-digit PIN setup, Lock Screen Overlay (styled like the Dashboard), 5-minute inactivity auto-lock, "Lock on Background" option.

### 3.2 Encrypted Backups (AES-GCM)
- **Implementation**:
